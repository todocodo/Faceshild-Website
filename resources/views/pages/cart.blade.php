                                ...
                                <tr>
                                    <td>
                                        <figure class="itemside">
                                            <div class="aside"><img src="../realphotos/package_front_1.jpg" class="img-sm"></div>
                                            <figcaption class="info">
                                                <a href="#" class="text-dark">Some name of item goes here nice</a>
                                ...
                                <tr>
                                    <td>
                                        <figure class="itemside">
                                            <div class="aside"><img src="../realphotos/package_front_1.jpg" class="img-sm"></div>
                                            <figcaption class="info">
                                                <a href="#" class="text-dark">Product name goes here nice</a>
                                                <p class="text-muted small">Size: XL, Color: blue, <br> Brand: Gucci</p>
                                            </figcaption>
                                        </figure>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <figure class="itemside">
                                            <div class="aside"><img src="../realphotos/package_front_1.jpg" class="img-sm"></div>
                                            <figcaption class="info">
                                                <a href="#" class="text-dark">Another name of some product goes just here</a>
