...
<div class="container py-4">
    ...
    <div class="text-center">
        <a class="btn btn-lg mt-2" style="background-color: #07b0b7; color:white;" href="../documents/TG_Certificate_CE_en.pdf" download>{{ __('Certificate') }}</a>
        <a class="btn btn-lg mt-2" style="background-color: #07b0b7; color:white;" href="../documents/TG_Certificate_CE_en.pdf" download>{{ __('Certificate in BG') }}</a>
    </div>
    ...
    <div class="border-top mt-3">
        ...
        <div class="text-center mt-2">
            <a class="btn btn-lg" style="background-color: #07b0b7; color:white;" href="../documents/nTrShield_Tech_Data_A4_EN.pdf" download>{{ __('Technical Data') }}</a>
        </div>
    </div>
    ...
    <div class="border-top mt-3">
        ...
        <div class="text-center mt-2">
            <a class="btn btn-lg" style="background-color: #07b0b7; color:white;" href="../documents/nTrShield_Instruction_EN.pdf" download>{{ __('Instructions') }}</a>
        </div>
    </div>
