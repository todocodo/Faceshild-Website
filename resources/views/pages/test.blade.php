...
<body>
    ...
    <img src="{{ $message ?? ''->embed(public_path() . '/photo/nTrShield_email_beginnning.png') }}" alt="email_beginning" style="width: 590px;">
    <br><br>
    ...
    <br>
    <img src="{{ $message ?? ''->embed(public_path() . '/photo/nTrShield_email_ending.png') }}" alt="email_ending" style="width: 590px;"><br>
